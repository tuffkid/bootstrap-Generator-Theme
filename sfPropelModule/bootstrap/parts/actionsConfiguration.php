...
<?php unset($this->config['actions']) ?>
  ...
  {
    return <?php echo $this->asPhp(isset($this->config['form']['actions']) ? $this->config['form']['actions'] : array('_delete' => null, '_list' => null, '_save' => null, '_previous' => null, '_next' => null)) ?>;
...
<?php unset($this->config['list']['batch_actions']) ?>
  ...
  {
    return <?php echo $this->asPhp(isset($this->config['filter']['actions']) ? $this->config['filter']['actions'] : array()) ?>;
<?php unset($this->config['filter']['actions']) ?>
  }
