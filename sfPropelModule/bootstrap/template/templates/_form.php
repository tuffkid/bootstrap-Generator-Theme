...
<table class="sf_admin_table_content">
    <tr>
        <td class="sf_admin_td_content">
            <div class="sf_admin_form" id="sf_admin_form_<?php echo $this->getModuleName() ?>">
